...
<img width="975" height="448" alt="image" src="./assets/windows-info.png" />
...
<img width="975" height="401" alt="image" src="./assets/msedge-cmdline.png" />

```bash
vol3 -f chall.dmp windows.pslist
```

<img width="975" height="455" alt="image" src="./assets/windows-pslist.png" />
...
<img width="881" height="429" alt="image" src="./assets/find-paste-form-context-output.png" />
